...
## nao_dcm_robot (indigo) - 0.0.5-0

The packages in the `nao_dcm_robot` repository were released into the `indigo` distro by running `/usr/bin/bloom-release nao_dcm_robot --track indigo --rosdistro indigo` on `Thu, 16 Nov 2017 14:59:30 -0000`
